...
import { Search, Download, BookOpen, AlertCircle, Book, Users, Sparkles, Mic, MicOff, PlayCircle, Headphones } from 'lucide-react';

// ============================================
// API SERVICE (Updated to Port 5000)
// ============================================
const api = {
          ...
          <div className="flex items-center justify-between pt-6 border-t border-gray-100">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={(e) => {
                  ...
                  link.href = data.pdf_url; // Just use the relative path
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="relative shadow-md rounded-lg flex items-center bg-white border border-gray-300 focus-within:ring-2 focus-within:ring-saffron-500 overflow-hidden">
          <input
            ...
            placeholder='Type or Speak... (e.g., "Samaysar padna hai")'
